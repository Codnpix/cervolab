...
function easy() {
    ...
    chevs[5].setSpeed(0.6, (direction + random(8,352)));
    chevs[6].setSpeed(0.6, (direction + random(8,352)));
    ship.maxSpeed = 0.9;
}
...
function medium() {
    ...
    chevs[5].setSpeed(1.3, (direction + random(8,352)));
    chevs[6].setSpeed(1.3, (direction + random(8,352)));
    ship.maxSpeed = 1;
}
...
function hard() {
    ...
    chevs[5].setSpeed(2.1, (direction + random(8,352)));
    chevs[6].setSpeed(2.1, (direction + random(8,352)));
    ship.maxSpeed = 1.3;
}